...
+ (NSArray *)loadSections {
  return @[ @"AgencyMap", @"Panorama", @"Overlays", @"Camera", @"Services" ];
}

+ (NSArray *)loadDemos {
  NSArray *mapDemos =
  @[[self newDemo:[BasicMapViewController class]
        withTitle:@"Basic AgencyMap"
   andDescription:nil],
    [self newDemo:[MapTypesViewController class]
        withTitle:@"AgencyMap Types"
   andDescription:nil],
    [self newDemo:[StyledMapViewController class]
        withTitle:@"Styled AgencyMap"
   andDescription:nil],
