...
import {
  Animated, SafeAreaView, View, StyleSheet, Dimensions, TouchableOpacity, Image,
} from 'react-native';
...
const BottomNavBar = (props) => {
  ...
  const onTabBarPress = (route, routeIndex, isFocuced) => {
    ...
    Animated.spring(translateValue, {
      toValue: isArabic ? -routeIndex * inactiveTabWidth : routeIndex * inactiveTabWidth,
      velocity: 10,
            ...
            >
              { options.isMainAction
                ...
                : (
                  <BottomNavItem
                    isFocused={isFocused}
                    tabBarIcon={isFocused ? options?.activeTabBarIcon : options?.inactiveTabBarIcon}
