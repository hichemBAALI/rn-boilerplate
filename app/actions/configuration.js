import { CHANGE_LANGUAGE, GET_LANGUAGES, IS_LOADING, STATUS_OK } from '../config/constants';
...
const dispatchChangeLanguage = lang => function (dispatch) {
...
const getLanguages = () => function (dispatch) {
  return new Promise((resolve, reject) => {
    axios.get(API_LANGUAGES).then((response) => {
      Log(response.data);
